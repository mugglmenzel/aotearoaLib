...
public class EvaluationResult implements Serializable {
    ...
    public String toString() {
        return "EvaluationResult{" +
                "resultMultiplicativeIndexMap=" + resultMultiplicativeIndexMap +
                ", resultAdditiveIndexMap=" + resultAdditiveIndexMap +
                ", resultPositiveGoalsMap=" + resultPositiveGoalsMap +
                ", resultNegativeGoalsMap=" + resultNegativeGoalsMap +
                '}';
    }
}
